    ...
    OApp
{
    ...
    string public constant name = "TestXLayer1155";
    string public constant symbol = "TX1155";
    ...
    constructor(
        ...
        address _endpoint,
        address _delegate
    ) ERC1155("") OApp(_endpoint, _delegate) Ownable(_delegate) EIP712("TestXLayer1155", "V1") {
